...
class SimpleProduct {
	...
	public function SimpleProductData($params,$ProcuctData,$ProductAttributeData,$ProductImageGallery,$ProductStockdata,$ProductSupperAttribute,$ProductCustomOption,$logMsg){
		...
		// echo "<pre>"; print_r($ProcuctData); exit;
		...
		$SetProductData->setData('url_key',$ProductAttributeData['url_key']);
		$SetProductData->setData('url_path',$ProductAttributeData['url_path']);
