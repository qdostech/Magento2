...
namespace Neo\Productlocation\Model\Config;
class ProductlocationCronConfig extends \Magento\Framework\App\Config\Value
{
    const CRON_STRING_PATH = 'crontab/default/jobs/cron_product_location_sync/schedule/cron_expr';
    const CRON_MODEL_PATH = 'crontab/default/jobs/cron_product_location_sync/run/model';
    ...
    public function afterSave(){
        $frequency = $this->getData('groups/autoSyncProductLocation/fields/frequency/value');
        $time = $this->getData('groups/autoSyncProductLocation/fields/time/value');
       // $productlocationSync=$this->getData('groups/autoSyncProductLocation/fields/add_new_sync_productlocation_schedule/value');

          $time1= $this->getData('groups/autoSyncProductLocation/fields/time2/value');
          $productlocationSync2=$this->getData('groups/autoSyncProductLocation/fields/add_new_sync_productlocation_schedule/value');

          $time2= $this->getData('groups/autoSyncProductLocation/fields/time3/value');
          $productlocationSync3=$this->getData('groups/autoSyncProductLocation/fields/add_another_new_sync_productlocation_schedule/value');

          $time3= $this->getData('groups/autoSyncProductLocation/fields/time4/value');
          $productlocationSync4=$this->getData('groups/autoSyncProductLocation/fields/add_another_new_one_sync_productlocation_schedule/value');
           $time4= $this->getData('groups/autoSyncProductLocation/fields/time4/value');
          $productlocationSync5=$this->getData('groups/autoSyncProductLocation/fields/add_another_new_two_sync_productlocation_schedule/value');




        $daysofmonth = $this->getData('groups/autoSyncProductLocation/fields/daysofmonth/value');
        $weekday = $this->getData('groups/autoSyncProductLocation/fields/weekdays/value');
