<?php
namespace Neo\Productlocation\Block\Adminhtml\Productlocation;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
   /**
    ...
    {
        parent::_construct();
        $this->setId('productlocationGrid');
        $this->setDefaultSort('log_id');
        $this->setDefaultDir('DESC');
        $this->setSaveParametersInSession(true);
        $this->setUseAjax(false);
        $this->setOptions($this->activitySync->getFilterOptions('get_location'));
    }
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem(
            ...
            array(
                'label' => __('Delete'),
                'url' => $this->getUrl('productlocation/*/massDelete'),
    ...
    {
        return $this->getUrl('productlocation/*/index', ['_current' => true]);
    }
