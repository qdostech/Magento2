<?php
namespace Neo\Productlocationqty\Block\Adminhtml\Productlocationqty;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
   /**
    ...
    protected function _construct()
    {
        ...
        $this->setOptions($this->activitySync->getFilterOptions('get_location_qty'));
    }
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem(
            ...
            array(
                'label' => __('Delete'),
                'url' => $this->getUrl('productlocationqty/*/massDelete'),
