...
namespace Neo\ImageCleaner\Model\Config;
class ProductImageDeleteCronConfig extends \Magento\Framework\App\Config\Value
{
    const CRON_STRING_PATH = 'crontab/default/jobs/cron_product_image_delete/schedule/cron_expr';
    const CRON_MODEL_PATH = 'crontab/default/jobs/cron_product_image_delete/run/model';
    ...
    public function afterSave(){
        $frequency = $this->getData('groups/autoDeleteProductImages/fields/frequency/value');
        $time = $this->getData('groups/autoDeleteProductImages/fields/time/value');
...
*/
        ...
        $daysofmonth = $this->getData('groups/autoDeleteProductImages/fields/daysofmonth/value');
        $weekday = $this->getData('groups/autoDeleteProductImages/fields/weekdays/value');
