<?php
namespace Qdos\CustomerSync\Block\Adminhtml\Synccustomer;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _construct()
    {
        ...
        $this->setOptions($this->activitySync->getFilterOptions('customer'));
    }
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem(
            ...
            array(
                'label' => __('Delete'),
                'url' => $this->getUrl('customersync/*/massDelete'),
    ...
    {
        return $this->getUrl('customersync/*/index', ['_current' => true]);
    }
