...
class SyncDeleteProduct extends \Magento\Backend\App\Action
{
    /**
    ...
    public function execute()
    {
        ...
        $syncDeleteStatus = $this->_scopeConfig->getValue('qdosConfig/permissions/manual_delete_product', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
