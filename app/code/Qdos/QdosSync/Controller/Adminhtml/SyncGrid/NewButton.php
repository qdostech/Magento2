...
class NewButton extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $syncProdStatus = $this->_scopeConfig->getValue('qdosConfig/permissions/manual_sync_product', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    ...
    /*public function execute()
    {
        $resultRedirect = $this->resultRedirectFactory->create();  
        $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
        $result = $objectManager->create('Qdos\QdosSync\Helper\Data')
