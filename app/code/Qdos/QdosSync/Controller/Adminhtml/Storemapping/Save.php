<?php
namespace Qdos\QdosSync\Controller\Adminhtml\Storemapping;
...
class Save extends \Magento\Backend\App\Action
{
	...
	public function execute()
    {
        ...
        if ($data) {
            $model = $this->_objectManager->create('Qdos\QdosSync\Model\Storemapping');
			...
			$data['sync_type'] = implode(',', $data['sync_type']); //added by pooja soni to set multiselect values in database.
            $model->setData($data);
