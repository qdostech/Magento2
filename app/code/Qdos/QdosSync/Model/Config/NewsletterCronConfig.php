...
class NewsletterCronConfig extends \Magento\Framework\App\Config\Value
{
    const CRON_STRING_PATH = 'crontab/default/jobs/cron_newsletter_sync/schedule/cron_expr';
    const CRON_MODEL_PATH = 'crontab/default/jobs/cron_newsletter_sync/run/model';
    ...
    public function afterSave(){
        ...
        $newsletterSync4=$this->getData('groups/autoSyncNewsletter/fields/add_another_new_one_sync_newsletter_schedule/value');
        $time3 = $this->getData('groups/autoSyncNewsletter/fields/time3/value');
        $newsletterSync5=$this->getData('groups/autoSyncNewsletter/fields/add_another_new_two_sync_newsletter_schedule/value');
        $time4 = $this->getData('groups/autoSyncNewsletter/fields/time4/value');
        ...
        $logger->info('in SyncNewsletter: '.$cronExprString." & ".$cronExprString1." & ".$cronExprString2." & ".$cronExprString3." & ".$cronExprString4);
