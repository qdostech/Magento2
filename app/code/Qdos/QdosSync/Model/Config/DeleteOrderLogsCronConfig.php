...
class DeleteOrderLogsCronConfig extends \Magento\Framework\App\Config\Value
{
    const CRON_STRING_PATH = 'crontab/default/jobs/cron_delete_order_logs/schedule/cron_expr';
    const CRON_MODEL_PATH = 'crontab/default/jobs/cron_delete_order_logs/run/model';
    ...
    public function afterSave(){
        $frequency = $this->getData('groups/autoDeleteOrderLogs/fields/frequency/value');
        $time = $this->getData('groups/autoDeleteOrderLogs/fields/time/value');
        $daysofmonth = $this->getData('groups/autoDeleteOrderLogs/fields/daysofmonth/value');
        $weekday = $this->getData('groups/autoDeleteOrderLogs/fields/weekdays/value');
        ...
        try{
            ...
            throw new \Exception(__("We can\'t save the cron expression for Delete Order Logs."));
        }
