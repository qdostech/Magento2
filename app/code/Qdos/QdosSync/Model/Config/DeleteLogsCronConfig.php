...
class DeleteLogsCronConfig extends \Magento\Framework\App\Config\Value
{
    const CRON_STRING_PATH = 'crontab/default/jobs/cron_delete_logs/schedule/cron_expr';
    const CRON_MODEL_PATH = 'crontab/default/jobs/cron_delete_logs/run/model';
    ...
    public function afterSave(){
        $frequency = $this->getData('groups/autoDeleteLogs/fields/frequency/value');
        $time = $this->getData('groups/autoDeleteLogs/fields/time/value');
        

        $time1 = $this->getData('groups/autoSyncProduct/fields/time1/value');
        $deleteLogSync2=$this->getData('groups/autoDeleteLogs/fields/add_new_schedule/value');

        $time2= $this->getData('groups/autoSyncProduct/fields/time1/value');
        $deleteLogSync3=$this->getData('groups/autoDeleteLogs/fields/add_new_delete_log_schedule/value');

        $time3= $this->getData('groups/autoSyncProduct/fields/time1/value');
        $deleteLogSync4=$this->getData('groups/autoDeleteLogs/fields/add_new_one_delete_log_schedule/value');

        $time4 = $this->getData('groups/autoSyncProduct/fields/time1/value');
        $deleteLogSync5=$this->getData('groups/autoDeleteLogs/fields/add_new_two_delete_log_schedule/value');


      


        $daysofmonth = $this->getData('groups/autoDeleteLogs/fields/daysofmonth/value');
        $weekday = $this->getData('groups/autoDeleteLogs/fields/weekdays/value');
       ...
       $cronExprMinute1 = $cronExprHour1 = $cronExprDay1 = $cronExprWeek1 = array();
        ...
        try{
            ...
            throw new \Exception(__("We can\'t save the cron expression for Delete Logs."));
        }
        if($deleteLogSync2){
            try{
                $this->_configValueFactory->create()->load(
