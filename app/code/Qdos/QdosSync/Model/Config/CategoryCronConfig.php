...
class CategoryCronConfig extends \Magento\Framework\App\Config\Value
{
	...
	public function afterSave(){
        ...
        $categorySync4=$this->getData('groups/autoSyncCategory/fields/add_new_one_sync_category_schedule/value');
        $time3 = $this->getData('groups/autoSyncCategory/fields/time3/value');
        $categorySync5=$this->getData('groups/autoSyncCategory/fields/add_new_two_sync_category_schedule/value');
        $time4 = $this->getData('groups/autoSyncCategory/fields/time4/value');
       ...
       $cronExprMinute2 = $cronExprHour2 = $cronExprDay2 = $cronExprWeek2 = array();
        ...
        $logger->info('in SyncCat : '.$cronExprString." & ".$cronExprString1." & ".$cronExprString2." & ".$cronExprString3." & ".$cronExprString4);
