...
class AttributeCronConfig extends \Magento\Framework\App\Config\Value
{
    ...
    public function afterSave(){
        ...
        $attributeSync4=$this->getData('groups/autoSyncAttribute/fields/add_new_one_sync_attribute_schedule/value');
        $time3 = $this->getData('groups/autoSyncAttribute/fields/time3/value');

        $attributeSync5=$this->getData('groups/autoSyncAttribute/fields/add_new_two_sync_attribute_schedule/value');
        $time4 = $this->getData('groups/autoSyncAttribute/fields/time4/value');
        ...
        /*Log code*/
        $writer = new \Zend\Log\Writer\Stream(BP . '/var/log/syncAttributCron.log');
        $logger = new \Zend\Log\Logger();
        $logger->addWriter($writer);

        $logger->info('in SyncAtt : '.$cronExprString." & ".$cronExprString1." & ".$cronExprString2." & ".$cronExprString3." & ".$cronExprString4);
