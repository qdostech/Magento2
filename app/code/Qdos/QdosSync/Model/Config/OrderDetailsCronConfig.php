...
class OrderDetailsCronConfig extends \Magento\Framework\App\Config\Value
{
    ...
    public function afterSave(){
        ...
        $orderdetailSync4=$this->getData('groups/autoSyncOrderDetails/fields/add_another_new_one_sync_order_schedule/value');
        $time3 = $this->getData('groups/autoSyncOrderDetails/fields/time3/value');
        $orderdetailSync5=$this->getData('groups/autoSyncOrderDetails/fields/add_another_new_two_sync_order_schedule/value');
        $time4 = $this->getData('groups/autoSyncOrderDetails/fields/time4/value');
        ...
        $logger->info('in SyncOrderDetails : '.$cronExprString." & ".$cronExprString1." & ".$cronExprString2." & ".$cronExprString3." & ".$cronExprString4);
