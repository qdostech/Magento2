...
class CronCategorySynchConfig extends \Magento\Framework\App\Config\Value
{
	const CRON_STRING_PATH = 'crontab/default/jobs/cron_category_synch/schedule/cron_expr';
	const CRON_MODEL_PATH = 'crontab/default/jobs/cron_category_synch/run/model';
