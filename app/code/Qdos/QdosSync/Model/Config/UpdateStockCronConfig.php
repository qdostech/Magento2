...
class UpdateStockCronConfig extends \Magento\Framework\App\Config\Value
{
    ...
    public function afterSave()
    {
        ...
        $productstockSync4=$this->getData('groups/autoUpdateStock/fields/add_another_new_one_update_stock_schedule/value');
        $time3 = $this->getData('groups/autoUpdateStock/fields/time3/value');
        $productstockSync5=$this->getData('groups/autoUpdateStock/fields/add_another_new_two_update_stock_schedule/value');
        $time4 = $this->getData('groups/autoUpdateStock/fields/time4/value');
        ...
        $logger->info('in SyncStock : '.$cronExprString." & ".$cronExprString1." & ".$cronExprString2." & ".$cronExprString3." & ".$cronExprString4);
        // echo $cronExprString; exit;

        if($productstockSync1){
            try {
