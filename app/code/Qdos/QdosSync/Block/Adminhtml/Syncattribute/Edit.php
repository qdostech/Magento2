...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    protected function _construct()
    {
        ...
        $this->_controller = 'adminhtml_syncattribute';
    ...
    /*START : Create sync Attributes button to call webservices*/
    protected function _prepareLayout()
        {
            $this->getToolbar()->addChild(
                        ...
                        [
                            'label' => __('Sync Attribute'),
                            'title' => __('Sync Attribute'),
    ...
    /*END : Create sync Attributes button to call webservices*/
}
