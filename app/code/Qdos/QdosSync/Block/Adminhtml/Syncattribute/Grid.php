<?php
namespace Qdos\QdosSync\Block\Adminhtml\Syncattribute;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    /**
     * @var \Qdos\QdosSync\Model\ResourceModel\Syncattribute\Collection
     */
    ...
    public function __construct(
		...
		//\Qdos\QdosSync\Model\ResourceModel\Syncattribute\Collection $collectionFactory,
    ...
    protected function _construct()
    {
        ...
        $this->setOptions($this->activitySync->getFilterOptions('attribute'));
    ...
    protected function _prepareCollection()
    {
		try{
			...
			$collection = $this->_collectionFactory
                          ->addFieldToFilter('from_batch',array('eq'=>0))
