...
namespace Qdos\Syncevent\Model\Config;
class EventCronConfig extends \Magento\Framework\App\Config\Value
{
    const CRON_STRING_PATH = 'crontab/default/jobs/cron_event_sync/schedule/cron_expr';
    const CRON_MODEL_PATH = 'crontab/default/jobs/cron_event_sync/run/model';
    ...
    public function afterSave(){
        $frequency = $this->getData('groups/autoSyncEvents/fields/frequency/value');
        $time = $this->getData('groups/autoSyncEvents/fields/time/value');
       // $eventSync=$this->getData('groups/autoSyncEvents/fields/add_new_sync_events_schedule/value');

          $time1= $this->getData('groups/autoSyncEvents/fields/time2/value');
          $eventSync2=$this->getData('groups/autoSyncEvents/fields/add_new_sync_events_schedule/value');

          $time2= $this->getData('groups/autoSyncEvents/fields/time3/value');
          $eventSync3=$this->getData('groups/autoSyncEvents/fields/add_another_new_sync_events_schedule/value');

          $time3= $this->getData('groups/autoSyncEvents/fields/time4/value');
          $eventSync4=$this->getData('groups/autoSyncEvents/fields/add_another_new_one_sync_events_schedule/value');
           $time4= $this->getData('groups/autoSyncEvents/fields/time4/value');
          $eventSync5=$this->getData('groups/autoSyncEvents/fields/add_another_new_two_sync_events_schedule/value');




        $daysofmonth = $this->getData('groups/autoSyncEvents/fields/daysofmonth/value');
        $weekday = $this->getData('groups/autoSyncEvents/fields/weekdays/value');
