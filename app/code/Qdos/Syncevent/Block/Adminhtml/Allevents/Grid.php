<?php
namespace Qdos\Syncevent\Block\Adminhtml\Allevents;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem(
            ...
            array(
                'label' => __('Delete'),
                'url' => $this->getUrl('syncevent/syncevent/massDelete'),
    ...
    {
        return $this->getUrl('syncevent/allsyncevent/index', ['_current' => true]);
    }
